...
namespace SnowBack.Migrations
{
    ...
    [Migration("20240424111539_InfraRelationsUpdate")]
    partial class InfraRelationsUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SnowBack.Models.JTask", b =>
                {
                    b.HasOne("SnowBack.Models.DStaff", "ExecutorNavigation")
                        .WithMany("JTasks")
                        .HasForeignKey("Executor")
                        .IsRequired()
                        .HasConstraintName("fk_executor");

                    b.Navigation("ExecutorNavigation");
                });
